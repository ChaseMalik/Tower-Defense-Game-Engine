...
public class BehaviorTester {
    ...
    public void testMovementBehaviorSimple() {
        ...
        IBehavior movement = new LinearMovement(myOptions, 2.5);
        BaseActor actor = new BaseActor(Arrays.asList(movement),null);
    ...
    public void testMovementBehaviorSimple2() {
        ...
        myOptions = Arrays.asList(route);
        IBehavior movement = new LinearMovement(myOptions, Math.sqrt(18));
        BaseActor actor = new BaseActor(Arrays.asList(movement),null);
        actor.update();
